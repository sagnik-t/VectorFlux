...
class TestPlaceholder:
    def test_returns_placeholder_node(self, t):
        ph = vf.placeholder([3])
        assert ph.type == "Placeholder"

    def test_name_propagated(self, t):
        ph = vf.placeholder([3], name="x")
        assert ph.name == "x"

    def test_fed_via_session(self, t):
        ph = vf.placeholder([3])
        sess = vf.Session()
...
class TestVariable:
    ...
    def test_used_directly_in_matmul(self, t):
    ...
    def test_repr_contains_name(self, t):
...
class TestSymbolicOps:
    ...
    def test_add_with_variable(self, t):
    ...
    def test_relu_with_variable(self, t):
        W = vf.Variable(t(np.array([-1.0, 2.0])))
        r = vf.relu(W)
        assert r.type == "Relu"
        sess = vf.Session()
...
class TestEagerOps:
    def test_add_with_tensors_returns_tensor(self, t):
...
class TestSessionApi:
    def test_run_variable_as_fetch(self, t):
    ...
    def test_run_variable_in_list(self, t):
    ...
    def test_feed_dict_with_variable_key(self, t):
    ...
    def test_feed_dict_variable_override_does_not_persist(self, t):
    ...
    def test_existing_node_feed_dict_still_works(self, t):
...
class TestGradientsApi:
    def test_gradients_with_variable_in_xs(self, t):
        """vf.gradients accepts Variable objects in xs."""
    ...
    def test_gradients_with_mixed_xs(self, t):
...
class TestIntegration:
    def test_two_layer_graph(self, t):
    ...
    def test_sgd_step_with_clean_api(self, t):
